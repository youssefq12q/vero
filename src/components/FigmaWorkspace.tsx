...
export default function FigmaWorkspace({ onClose }: FigmaWorkspaceProps) {
  ...
  const [selectedElement, setSelectedElement] =
    React.useState<string>("palette-gold");
  const [copiedText, setCopiedText] = React.useState<string | null>(null);
  const [scale, setScale] = React.useState<number>(100);
  const [sidebarOpen, setSidebarOpen] = React.useState(true);
  const [inspectTab, setInspectTab] = React.useState<"design" | "inspect">(
    "design",
  );
      ...
      const tokenSpecs = {
        ...
        colorPalette: {
          brandGold: {
            ...
            description:
              "Primary brand accent color representing heritage and refined solid gold.",
          },
          brandLinen: {
            hex: "#F5EFEB",
            tailwind: "bg-brand-linen",
            description:
              "Background canvas representing clean, sustainable Mediterranean linen textures.",
          },
          brandUmber: {
            hex: "#211B12",
            tailwind: "bg-brand-umber",
            description:
              "Primary typography and structure color representing deep charcoal and Italian wood.",
          },
          brandOutline: {
            hex: "#8A817C",
            tailwind: "bg-brand-outline",
            description: "Secondary text and borders indicating subtle lines.",
          },
          brandSurfaceLow: {
            hex: "#EDE6E0",
            tailwind: "bg-brand-surface-low",
            description: "Subtle background cards and container fillings.",
          },
        },
        typography: {
        ...
        components: [
          ...
          "Dynamic Checkout Drawer",
        ],
      };

      const dataStr =
        "data:text/json;charset=utf-8," +
        encodeURIComponent(JSON.stringify(tokenSpecs, null, 2));
  ...
  > = {
    ...
    "typo-display": {
      ...
      codeTailwind:
        "font-serif text-3xl md:text-4xl tracking-wide text-brand-umber",
      codeCSS:
    ...
    "typo-sans": {
      ...
      codeTailwind:
        "font-sans text-xs md:text-sm text-brand-outline font-light leading-relaxed",
      codeCSS:
    ...
    "comp-button": {
      ...
      codeTailwind:
        "bg-brand-gold hover:bg-brand-umber text-white font-sans text-xs font-semibold py-4 px-10 uppercase tracking-[0.2em] transition-all duration-300 shadow-sm",
      codeCSS:
  ...
  const currentSpec =
    elementSpecs[selectedElement] || elementSpecs["palette-gold"];
    ...
    <div className="flex flex-col h-[85vh] bg-[#1E1E1E] text-[#E3E3E3] rounded-lg border border-[#333333] overflow-hidden font-sans shadow-2xl relative select-text">
      ...
      <div className="bg-[#2C2C2C] border-b border-[#3E3E3E] h-12 flex items-center justify-between px-4 select-none">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1.5 text-xs text-white">
            ...
            <span className="font-medium tracking-wide">
              VERO Accessories UI Design Spec
            </span>
        ...
        <div className="hidden md:flex items-center bg-[#1E1E1E]/80 border border-[#3E3E3E] rounded-md px-1 py-0.5 shadow-inner">
          <button
            className="p-1.5 hover:bg-[#2C2C2C] text-[#A259FF] rounded-md transition-colors"
            title="Move Tool">
            <MousePointer className="w-3.5 h-3.5" />
          </button>
          <button
            className="p-1.5 hover:bg-[#2C2C2C] text-gray-400 rounded-md transition-colors"
            title="Hand Tool">
      ...
      <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-60 bg-[#2C2C2C] border-r border-[#3E3E3E] flex flex-col justify-between select-none">
                  ...
                  {activePage === "tokens" && (
                    <>
                      <div
                        ...
                        <span className="text-[#A259FF]">■</span> Color: Gold
                        Accent
                      </div>
                      <div
                        ...
                        <span className="text-[#A259FF]">■</span> Color: Sand
                        Linen
                      </div>
                      <div
                        ...
                        <span className="text-[#A259FF]">■</span> Color: Deep
                        Umber
                      </div>
                    </>
                  )}
                  ...
                  {activePage === "typography" && (
                    <>
                      <div
                        ...
                        <span className="text-[#0ACF83]">T</span> Heading: Serif
                        Display
                      </div>
                      <div
                        ...
                        <span className="text-[#0ACF83]">T</span> Body: Inter
                        Sans-serif
                      </div>
                    </>
                  )}
                  ...
                  {activePage === "components" && (
                    <>
                      <div
                        ...
                        <span className="text-[#A259FF]">❖</span> Button:
                        Primary
                      </div>
                    </>
                  )}
            ...
            <div className="p-4 bg-[#1E1E1E]/40 border-t border-[#3E3E3E] m-2 rounded-md space-y-2">
              ...
              <p className="text-[9px] text-gray-400 font-light leading-relaxed">
                This Figma spec matches our code's exact design guidelines.
                Modify properties on the right to preview.
              </p>
            </div>
          </div>
        )}
        ...
        <div className="flex-1 bg-[#191919] relative overflow-hidden flex items-center justify-center p-6 md:p-10">
          ...
          <motion.div
            ...
            <div className="absolute -top-3 left-0 text-[9px] font-mono text-gray-500 select-none">
              X: 200 Y: 120
            </div>
            <div className="absolute -left-3 top-0 text-[9px] font-mono text-gray-500 origin-bottom-left -rotate-90 select-none">
              H: 480
            </div>
            ...
            <div className="min-h-[300px] flex flex-col justify-between">
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-xs text-gray-400 font-light max-w-md">
                      Interactive color styles defined in the VERO digital brand
                      guidelines. Click a color swatch below to inspect and copy
                      styling classes in Figma's inspector.
                    </p>
                  </div>
              ...
              {activePage === "typography" && (
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-xs text-gray-400 font-light max-w-md">
                      Pairing elegant historical display fonts with extremely
                      readable monospace and neutral sans-serif geometries.
                    </p>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div
                      ...
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-[10px] font-mono text-gray-500">
                          Inter Regular (Light 300)
                        </span>
                      </div>
                      <p className="font-sans text-xs text-gray-300 font-light leading-relaxed">
                        Designed for the modern individual who values artisanal
                        quality and sustainable restraint. Made to last
                        generations without losing a molecule of majestic
                        brilliance.
                      </p>
                    </div>
                  </div>
              ...
              {activePage === "components" && (
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-xs text-gray-400 font-light max-w-md">
                      Live interactive rendered components. Feel free to
                      interact with them inside the design sandbox!
                    </p>
                  </div>
              ...
              {activePage === "mockups" && (
                <div className="space-y-6 text-center">
                  <div className="text-left">
                    <h3 className="font-serif text-2xl text-white mb-2 font-normal">
                      Figma Web Mockup Canvas
                    </h3>
                    <p className="text-xs text-gray-400 font-light max-w-md">
                      A visual mockup generated by our creative engine
                      reflecting the authentic layout, borders, and spacing
                      specs.
                    </p>
                  </div>
              ...
              <div className="pt-6 border-t border-white/5 flex justify-between items-center mt-8">
                <span className="font-serif text-lg tracking-[0.25em] text-brand-gold uppercase">
                  VERO
                </span>
              ...
              <>
                ...
                <div className="space-y-3.5 pt-4 border-t border-[#3E3E3E]">
                  ...
                  <div className="space-y-2.5">
                    {currentSpec.properties.map((prop, i) => (
                      <div
                        key={i}
                        className="flex justify-between items-center text-xs border-b border-[#3E3E3E]/30 pb-2">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          {(prop.label.includes("Hex") ||
                            prop.label.includes("Family")) && (
                            <button
                              onClick={() =>
                                handleCopy(prop.value, `${prop.label}-${i}`)
                              }
                ...
                <div className="bg-[#1E1E1E] p-3.5 rounded-sm border border-[#3E3E3E] space-y-2.5">
                  ...
                  <p className="text-[10px] text-gray-400 font-light leading-relaxed">
                    You can easily convert this boutique application into a
                    native, vector-layered Figma file!
                  </p>
                  <ol className="text-[9.5px] text-gray-400 font-light list-decimal list-inside space-y-1 pl-1">
                    ...
                    <li>
                      Paste our live boutique URL inside the plugin inputs
                    </li>
                    <li>
                      Click <strong className="text-[#A259FF]">Import</strong>{" "}
                      to forge beautiful, editable Figma vectors!
                    </li>
                  </ol>
              ...
              <>
                ...
                <div className="space-y-2 pt-4 border-t border-[#3E3E3E]">
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      onClick={() =>
                        handleCopy(currentSpec.codeTailwind, "tailwind")
                      }
                ...
                <motion.div
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[9.5px] text-gray-300 font-light leading-snug">
                      Your VERO Design System JSON specs file has been exported
                      beautifully. Ready to import to any Figma design system
                      token runner.
                    </p>
                  </div>
                </motion.div>
