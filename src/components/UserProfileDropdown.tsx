          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="space-y-2">
              ...
              {(() => {
                ...
                const orderPointsRuleText = "مكافآت الطلبات (<500ج = 25ن | 500-700ج = 50ن | >700ج = 100ن) 🎁";
                list.push({ text: orderPointsRuleText });
              ...
              <div className="max-h-36 overflow-y-auto space-y-1.5 pr-1 scrollbar-thin">
                {userOrders.length === 0 ? (
                  ...
                  userOrders.map((order, idx) => (
                    <div 
                      key={idx} 
                      className="flex justify-between items-center bg-white border border-[#c5a880]/15 rounded-lg p-2 text-[9.5px] hover:border-brand-gold/40 transition-all cursor-pointer group"
                      onClick={() => {
                        if (onTrackOrder) {
                    ...
                    >
                      <div>
                        <p className="font-semibold text-brand-dark uppercase tracking-wider group-hover:text-brand-gold transition-colors">{order.itemName || "Boutique Order"}</p>
                      ...
                      <div className="text-right flex flex-col items-end gap-0.5">
                        ...
                        <span className="text-[7.5px] font-bold text-brand-dark bg-[#c5a880]/15 group-hover:bg-brand-gold group-hover:text-white px-2 py-0.5 rounded transition-all">
                          تتبع الشحنة 🚚
                        </span>
                      </div>
                    </div>
