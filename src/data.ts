...
export const PRODUCTS: Product[] = [
  {
    ...
    tagline: "\"A masterwork of 18k yellow gold sculpted to absolute perfection.\"",
    description: "Hand-finished 18k yellow gold ring with fluid organic ripples inspired by classic Roman aurelians. Exudes eternal luxury and understated power.",
    ...
    craftsmanship: "Each ring is meticulously forged and finished by master goldsmiths under 40x magnification. We treat each aurelian curve with absolute devotion, preserving ancient European techniques."
  },
  {
    ...
    description: "An extraordinary cushion-cut centerpiece diamond flanked by pure ice-clear baguette diamonds on a solid 18k white gold band.",
    ...
    craftsmanship: "Precision diamond-setting by master gemologists inside our state-of-the-art laboratory."
  },
  {
    id: "vero-chronos",
    ...
    tagline: "\"Premium chronograph with solid platinum bezel and sapphire crystal.\"",
    description: "A high-complication mechanical chronograph with custom-engraved Arabic numbers, solid platinum bezel, sapphire exhibition caseback, and handmade alligator-grain strap.",
    ...
    craftsmanship: "Assembled by certified master watchmakers, requiring over 120 hours of micro-engineering testing."
  },
  {
    id: "lucent-chain",
    ...
    tagline: "\"Delicate 18k white gold chain adorned with sparkling micro-diamonds.\"",
    description: "A slender, high-sparkle chain designed to catch the candlelight of the grandest galas. Features pavé-set diamonds that trace the collarbone elegantly.",
    materialOptions: ["#E5E4E2", "#E5D5BC"],
    ...
    craftsmanship: "Hand-linked chains crafted in Vicenza, Italy, renowned for historical gold forging."
  },
  {
    id: "geometric-aura",
    ...
    description: "Symmetric hand-finished earrings with faceted geometric panels that catch and reflect natural light beautifully. A modern architectural statement.",
  ...
  },
  {
    ...
    description: "A continuous, solid loop representing infinity. Minimalist engineering yields a perfectly balanced weight that feels like a second skin.",
    materialOptions: ["#E5E4E2", "#E5D5BC"],
  ...
  },
  {
    ...
    tagline: "\"An enduring legacy watch crafted with premium mechanical movement.\"",
    description: "An extraordinary masterpiece timepiece with a vintage-inspired dial, hand-painted numbering, and high-beat automatic movement that ticks with timeless precision.",
  ...
  },
  {
    ...
    description: "Interlocking flat V-links sculpted from pure 18k gold. The perfect companion for both formal evenings and daily professional wear.",
  ...
  },
  {
    ...
    tagline: "\"Vintage-inspired automatic watch with deep dark face and leather strap.\"",
    description: "A stunning tribute to twentieth-century horology. Features a deep charcoal dial, luminescent numerals, and high-frequency movement.",
  ...
  },
  {
    ...
    tagline: "\"Travel case crafted in vegetable-tanned leather to shield your timepieces.\"",
    description: "Hand-stitched three-slot luxury travel case lined with premium micro-suede to secure and preserve your delicate timepieces while traveling.",
  ...
  },
  {
    ...
    tagline: "\"Sleek, hand-stitched leather cardholder made of premium calfskin.\"",
    description: "Ultra-slim luxury pocket cardholder hand-crafted from the finest vegetable-tanned calfskin. Features 4 card slots and an elegant central pocket.",
  ...
  },
  {
    ...
    description: "Three entwined bands representing friendship, fidelity, and love, set with micro-pavé diamonds of pristine clarity and unmatched brilliance.",
    materialOptions: ["#E5D5BC", "#E5E4E2"],
